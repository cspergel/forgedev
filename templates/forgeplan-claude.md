...
- `.forgeplan/config.yaml` `design.profiles`, `design.mixins`, `design.blend_notes` — Optional composed frontend design direction (built-ins plus imported `awesome/<slug>` profiles)
